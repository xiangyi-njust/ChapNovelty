...
class get_stats():
    ...
    def count_document(self, per_year = False):
        ...
        if per_year:
            if self.client_name:
                for coll in tqdm(self.db.list_collection_names()):
                    counts = []
    ...
    def get_density_paper_per_author(self, collection_authors, author_id, list_name):
        ...
        self.n_papers = [len(doc[list_name]) for doc in tqdm(docs)]
    ...
    def get_density_reference_per_paper(self, collection_ref, references_variable, per_year = False):
        ...
        if per_year == False:
            ...
            self.n_ref = [len(doc[references_variable]) for doc in tqdm(docs)]
    ...
    def get_density_meshterms_per_paper(self, collection_meshterms, meshterms_variable, per_year = False):
        ...
        if per_year == False:
            ...
            self.n_meshterms = [len(doc[meshterms_variable]) for doc in tqdm(docs)]
